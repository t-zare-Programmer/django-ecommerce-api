...
class Brand(models.Model):
    ...
    image_name = models.ImageField(upload_to= file_upload.upload_to , null=True, blank=True, verbose_name='تصویر برند کالا')
...
class ProductGroup(models.Model):
    ...
    image_name = models.ImageField(upload_to=file_upload.upload_to, null=True, blank=True, verbose_name='تصویر گروه کالا')
...
class Product(models.Model):
    ...
    image_name = models.ImageField(upload_to=file_upload.upload_to, null=True, blank=True, verbose_name='تصویر کالا')
